    ...
    <div className="min-h-screen">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 group">
        ...
        <div className="bg-white text-gray-800 text-sm font-medium px-3 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 pointer-events-none whitespace-nowrap">
          💬 Fale conosco agora!
          <div className="absolute right-3 bottom-[-6px] w-3 h-3 bg-white rotate-45 shadow-sm" />
        </div>
        ...
        <div className="relative">
          ...
          <a
            ...
            className="relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110"
