...
const projetos = [
  ...
  {
    id: 12,
    titulo: "Stand Neugebauer APAS Show",
    cliente: "Neugebauer",
    evento: "APAS Show — São Paulo/SP",
    categoria: "Personalizado",
    imagem: null,
    video: null,
    galeria: [],
    vip: true,
    descricao: "Stand premium para a Neugebauer na APAS Show em maio de 2026. Projeto sofisticado em São Paulo/SP com exposição de produtos, área de degustação e relacionamento com clientes no maior evento de alimentos e bebidas do Brasil.",
  },
  {
    id: 13,
    titulo: "Stand Aromasil APAS Show",
    cliente: "Aromasil",
    evento: "APAS Show — São Paulo/SP",
    categoria: "Personalizado",
    imagem: null,
    ...
    galeria: [],
    vip: false,
    descricao: "Stand personalizado para a Aromasil na APAS Show em maio de 2026. Projeto com design moderno para exposição de produtos aromáticos e cosméticos em São Paulo/SP.",
  },
  {
    id: 14,
    titulo: "Stand Alcafoods APAS Show",
    cliente: "Alcafoods",
    evento: "APAS Show — São Paulo/SP",
    categoria: "Personalizado",
    imagem: null,
    ...
    galeria: [],
    vip: false,
    descricao: "Stand personalizado para a Alcafoods na APAS Show em maio de 2026. Projeto com foco em exposição de alimentos e área de degustação em São Paulo/SP.",
  },
  {
    id: 15,
    titulo: "Stand Siry Global",
    cliente: "Siry Global",
  ...
  },
  {
    ...
    video: "/manus-storage/STANDNEUGEBAUEREXPOAPRAS_869fc157.mp4",
