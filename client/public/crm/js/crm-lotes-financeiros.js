...
(function () {
  ...
  function renderLoteWorkspace() {
    ...
    return `<div class="space-y-5">
      ...
      ${confirmed ? `<div class="rounded-xl border border-emerald-200 bg-emerald-50 p-5"><h4 class="font-bold text-emerald-900"><i class="fas fa-check-circle mr-2"></i>Lote confirmado</h4><p class="mt-1 text-sm text-emerald-800">Os lançamentos foram criados e seus identificadores estão preservados em cada item para auditoria.</p></div>` : renderItemForm()}
  ...
  async function addItem() {
    ...
    const payload = {
      ...
      primeiroVencimento: document.querySelector('[data-finance-batch-item-vencimento]')?.value,
